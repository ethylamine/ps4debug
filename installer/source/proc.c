...
int proc_create_thread(struct proc *p, uint64_t address) {
    ...
    // libkernel.sprx
    // 0x12AA0 scePthreadCreate, 0x11570 4.55
    // 0x84C20 thr_initial, 0x7CD20 4.55

    // libkernel_web.sprx
    // 0x98C0 scePthreadCreate, 0x11570 4.55
    // 0x84C20 thr_initial, 0x7CD20 4.55

    // libkernel_sys.sprx
    // 0x135D0 scePthreadCreate, 0x120A0 4.55
    // 0x89030 thr_initial, 0x80D20 4.55
